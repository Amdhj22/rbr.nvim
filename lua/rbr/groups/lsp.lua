...
function M.get(ctx)
  ...
  return {
    ...
    ["@lsp.type.enumMember"]    = { fg = p.crowd_orange },
    ["@lsp.type.event"]         = { fg = p.sky_blue },
    ["@lsp.type.function"]      = { fg = p.oracle_blue },
    ["@lsp.type.interface"]     = { fg = p.rb_yellow,   italic = true },
    ["@lsp.type.keyword"]       = { fg = p.kerb_red },
    ["@lsp.type.macro"]         = { fg = p.sky_blue },
    ["@lsp.type.method"]        = { fg = p.oracle_blue },
    ["@lsp.type.modifier"]      = { fg = p.kerb_red },
    ["@lsp.type.namespace"]     = { fg = p.crowd_orange },
    ["@lsp.type.number"]        = { fg = p.crowd_orange },
    ["@lsp.type.operator"]      = { fg = p.subtext1 },
    ["@lsp.type.parameter"]     = { fg = p.crowd_orange },
    ["@lsp.type.property"]      = { fg = p.text },
    ["@lsp.type.regexp"]        = { fg = p.crowd_orange },
